...
% Ver01 : Power System의 기본 정보를 입력받는 코드 작성
% Y matrix 계산까지 구현
...
V(1,:,1) = [1 1 1.05 1 1];
Delta(1,:,1) = [0 0 0 0 0];
P_G(1,:,1) = [0 0 5.2 0 0];     % [4 0 5.2 0 0]
Q_G(1,:,1) = [0 0 0 0 0];
P_L(1,:,1) = [0 8 0.8 0 0];
Q_L(1,:,1) = [0 0 4.0 0 0];
...
% 
% for i = 1:SIZE
%     Bus_Type(1,i) = input(sprintf('Bus%d (Slack : 0, Gen(PV) : 1, Load(PQ) : 2) : ',i));
% end

% 입력하기 애매한 값은 일단 입력받고 Bus Type 별로 마지막에 0으로 돌리기
% P_G(1,:,1) = [0 0 5.2 0 0];     
% Q_G(1,:,1) = [0 0 0 0 0];
% P_L(1,:,1) = [0 8.0 0.8 0 0];
